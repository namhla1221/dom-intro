...
describe("use values", function() {
    ...
    it("should be able to use the call cost set for 2 calls 1.35 each", function() {
...
it("it should return a class name of 'critical' if level has been reached", function() {
    let settingsBill = BillWithSettings();
    ...
    it("it should stop the Total Call cost from increasing when the critical has been reached a class name of 'critical' if level has been reached", function() {
        let settingsBill = BillWithSettings();
